...
def main():
    ...
    formula_choice = int(input("Input index:"))
    chosen_formula = formulas[formula_choice]

    print("Choose an unknown var:")
    i = 1
    for var in chosen_formula["variables"]:
        print("{}. {}".format(i, var))
        i += 1

    unknown_var_index = int(input("Input index:")) - 1
    unknown_var = chosen_formula["variables"].pop(unknown_var_index)

    known_values = {}
    for var in chosen_formula["variables"]:
        known_values[var] = float(input("{}:".format(var)))
    ...
    print("{} is {}".format(unknown_var, known_values[unknown_var]))
